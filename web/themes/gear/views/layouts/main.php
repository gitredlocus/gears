...
<div class="navbar navbar-top navbar-inverse">
  <div class="navbar-inner">
    <div class="container-fluid">
      ...
      <a class="brand" href="#">Gear Apps</a>
            ...
            <ul class="nav full pull-right">
              <li class="dropdown user-avatar">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span>
                    <img class="menu-avatar" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatars/avatar1.jpg" /> <span>John Smith <i class="icon-caret-down"></i></span>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="with-image">
                    <div class="avatar">
                      <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatars/avatar1.jpg" />
                    </div>
...
<ul class="chat-box timeline">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatars/avatar1.jpg" /></div>
    <div class="info">
      <span class="name">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatars/avatar2.jpg" /></div>
    <div class="info">
      <span class="name">
