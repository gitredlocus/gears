...
<div class="primary-sidebar">
  ...
  <ul class="nav nav-collapse collapse nav-collapse-primary">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#gPTFeWzKYZ">
              ...
              <ul id="gPTFeWzKYZ" class="collapse ">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#vC4RuSbURQ">
              ...
              <ul id="vC4RuSbURQ" class="collapse ">
  ...
  <div class="hidden-tablet hidden-phone">
    ...
    <div class="sparkline-box side">
      ...
      <div class="sparkline-row">
        ...
        <div class="sparkline big" data-color="gray"><!--3,8,14,24,5,19,14,10,8,26,19,15--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="dark-green"><span>Income</span> $43.330</h4>
        <div class="sparkline big" data-color="darkGreen"><!--16,10,5,17,23,24,10,19,15,16,24,25--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="blue"><span>Reviews</span> 223</h4>
        <div class="sparkline big" data-color="blue"><!--16,21,9,29,7,26,29,29,20,25,29,28--></div>
      </div>
