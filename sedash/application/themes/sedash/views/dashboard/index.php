      ...
      <div class="area-top clearfix">
        ...
        <ul class="inline pull-right sparkline-box">
          ...
          <li class="sparkline-row">
            ...
            <div class="sparkline big" data-color="blue"><!--22,16,18,11,29,20,27,11,11,23,29,17--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="green"><span>Reviews</span> 223</h4>
            <div class="sparkline big" data-color="green"><!--20,15,13,15,4,14,20,21,22,15,7,26--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="red"><span>New visits</span> 7930</h4>
            <div class="sparkline big"><!--26,7,23,13,23,10,12,4,12,8,11,7--></div>
          </li>
...
<ul class="chat-box timeline">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="/img/avatars/avatar1.jpg" /></div>
    <div class="info">
      <span class="name">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="/img/avatars/avatar2.jpg" /></div>
    <div class="info">
      <span class="name">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="/img/avatars/avatar3.jpg" /></div>
    <div class="info">
      <span class="name">
